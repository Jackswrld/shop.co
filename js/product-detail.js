...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadReviews() {
    ...
    // Get first 6 reviews
    const reviewsToShow = productReviews.slice(0, 6);
    ...
    // Update review count
    document.querySelector('.reviews-count').textContent = `(${productReviews.length})`;
    
    console.log('✅ Reviews loaded:', productReviews.length);
  }
